...
import lab4.LeastSquaresApproximator;
...
//        }
    ...
    public static void printResult(Map<Functions, LeastSquaresApproximator.Output> outputs, Reader.ApproximationInputData entered) {
        printHeader();
        ArrayList<Double> X = (ArrayList<Double>) entered.getLINE_X();
        ArrayList<Double> Y = (ArrayList<Double>) entered.getLINE_Y();
        List<Functions> functions = Arrays.asList(Functions.values());
        for (int i = 0; i < entered.getLINE_X().size(); i++) {
            double x_i = X.get(i);
    ...
    public static void saveToFile(Map<Functions, LeastSquaresApproximator.Output> outputs, Reader.ApproximationInputData entered){
        try {
